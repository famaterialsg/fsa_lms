...
def module_group_add(request):
    ...
    return render(request, 'module_group_form.html', {'form': form,'module_groups': module_groups})
...
def module_detail(request, pk):
    ...
    module_groups = ModuleGroup.objects.all()
    return render(request, 'module_detail.html', {'module': module,'module_groups': module_groups})
...
def module_add(request):
    ...
    if request.method == 'POST':
        ...
        form = ModuleForm()
    return render(request, 'module_form.html', {'form': form,'module_groups': module_groups})
